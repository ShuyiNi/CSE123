...
void sr_handle_ip_forwarding(struct sr_instance*, uint8_t*, unsigned int, struct sr_if*);
void sr_handle_icmp_t3(struct sr_instance*, uint8_t*, uint8_t, uint8_t, struct sr_if*);
